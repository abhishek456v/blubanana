...
<style>
  * { box-sizing: border-box; margin: 0; }
  body {
    ...
    background-image: radial-gradient(620px 420px at 88% 8%, #E7EDF8, transparent 68%);
  }
  .mark { font-size: 34px; font-weight: 700; letter-spacing: -.035em; }
  .mark b { color: #023C85; font-weight: 700; }
  ...
  .chip { padding: 11px 20px; border-radius: 999px; background: #F1F5FC; color: #023C85; font-size: 20px; font-weight: 500; }
</style></head><body>
...
await browser.close()
console.log('website/assets/og.png')
